...
export default function Save() {
	return (
		<div className="new-guarant">
			<div className="new-guarant__slider">
				<div className="new-guarant__prev">
					<svg
				...
				<div className="new-guarant__next">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 24 24"
						fill="rgba(50,93,156,1)"
				...
				<div className="new-guarant__body swiper">
					<div className="new-guarant__items swiper-wrapper">
						<InnerBlocks.Content />
					</div>
				</div>
			</div>
			<div className="new-guarant__pagination"></div>
		</div>
	);
}
